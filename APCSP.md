...
> 考试日期和 Create Task 最终提交时间每年可能变化，最终以 College Board、AP Digital Portfolio 和学校 AP Coordinator 的通知为准。
...
* **Program Code**：完整程序代码
* **Video**：展示程序运行效果的视频
* **Personalized Project Reference**：考试时会用到的个人项目代码参考材料

注意：

* College Board 要求至少提供 **9 小时课堂时间** 完成 Create Performance Task。
* 程序代码可以在规定范围内合作完成。
* 但是 **Video** 和 **Personalized Project Reference** 必须由学生个人独立完成。
* Personalized Project Reference 里不要加入额外注释或解释，只保留要求的代码截图。
* 必须在 AP Digital Portfolio 中点击 **Submit Final**，否则可能无法计分。
...
# AP CSP Big Ideas / 五大核心主题

## 1. Creative Development 10–13% <br> 1. 创意开发 10–13%

### 1.1 Collaboration <br> 协作

### 1.2 Program Function and Purpose <br> 程序功能与目的

### 1.3 Program Design and Development <br> 程序设计与开发

### 1.4 Identifying and Correcting Errors <br> 识别和纠正错误

## 2. Data 17–22% <br> 2. 数据 17–22%

### 2.1 Binary Numbers <br> 二进制数

### 2.2 Data Compression <br> 数据压缩

### 2.3 Extracting Information from Data <br> 从数据中提取信息

### 2.4 Using Programs with Data <br> 使用程序处理数据

## 3. Algorithms and Programming 30–35% <br> 3. 算法与编程 30–35%

### 3.1 Variables and Assignments <br> 变量与赋值

### 3.2 Data Abstraction <br> 数据抽象

### 3.3 Mathematical Expressions <br> 数学表达式

### 3.4 Strings <br> 字符串

### 3.5 Boolean Expressions <br> 布尔表达式

### 3.6 Conditionals <br> 条件语句

### 3.7 Nested Conditionals <br> 嵌套条件语句

### 3.8 Iteration <br> 迭代 / 循环

### 3.9 Developing Algorithms <br> 设计算法

### 3.10 Lists <br> 列表

### 3.11 Binary Search <br> 二分查找

### 3.12 Calling Procedures <br> 调用过程 / 函数

### 3.13 Developing Procedures <br> 编写过程 / 函数

### 3.14 Libraries <br> 程序库

### 3.15 Random Values <br> 随机值

### 3.16 Simulations <br> 模拟

### 3.17 Algorithmic Efficiency <br> 算法效率

### 3.18 Undecidable Problems <br> 不可判定问题

## 4. Computer Systems and Networks 11–15% <br> 4. 计算机系统与网络 11–15%

### 4.1 The Internet <br> 互联网

### 4.2 Fault Tolerance <br> 容错

### 4.3 Parallel and Distributed Computing <br> 并行计算与分布式计算

## 5. Impact of Computing 21–26% <br> 5. 计算影响 21–26%

### 5.1 Beneficial and Harmful Effects <br> 有益和有害影响

### 5.2 Digital Divide <br> 数字鸿沟

### 5.3 Computing Bias <br> 计算偏见

### 5.4 Crowdsourcing <br> 众包

### 5.5 Legal and Ethical Concerns <br> 法律和伦理问题

### 5.6 Safe Computing <br> 安全计算
...
* 题目：2 题
* 实际 prompts：4 个小问题
* 内容：全部围绕你提交的 Create Performance Task
* 参考材料：考试时会提供你的 Personalized Project Reference
* 核心能力：解释自己的程序，而不是背模板
...
* list 不能只是一个元素。
* list 的使用必须和程序功能有关。
* selection 和 iteration 不能是无意义的装饰，必须影响程序结果。
* procedure call 必须和 procedure header 匹配。
...
### 原题方向
1. Identify an example output of your program. Explain how this output shows an aspect of your
program’s functionality.
题目要求学生说明程序的一个输出，并解释这个输出如何体现程序的功能。
...
* 你的 list 存储了什么数据
* 代码如何访问或处理 list
* 如果 list 变长，循环、索引、条件判断或数据处理方式是否仍然有效
* 如果不需要修改，要说明代码本来就会遍历整个 list 或自动处理所有元素
...
* 我的 procedure 是什么？
* procedure 在哪里被调用？
* procedure 里有没有 selection？
* procedure 里有没有 iteration？
* 如果某个条件为 true，为什么会进入这个分支？
* 如果别人改错了我的 procedure，会造成什么 logic error？
* 如果 list 增加更多元素，我的程序是否还能正常处理？
...
* [AP CSP Course 页面](https://apcentral.collegeboard.org/courses/ap-computer-science-principles)
* [AP CSP Assessment 页面](https://apstudents.collegeboard.org/courses/ap-computer-science-principles/assessment)
* [AP CSP Past Exam Questions](https://apcentral.collegeboard.org/courses/ap-computer-science-principles/exam/past-exam-questions)
