...
<table>
    ...
    <tr>
        ...
        <td>Response is sustained and sufficient to the task. It is generally well developed and coherent; relationships between ideas are clear (or there is a clear progression of ideas).<br>表达连贯、展开充分，逻辑清晰，任务完成度高。</td>
    </tr>
    <tr>
        <td>3</td>
        ...
        <td>Response is mostly coherent and sustained and conveys relevant ideas/information. Overall development is somewhat limited, usually lacks elaboration or specificity. Relationships between ideas may at times not be immediately clear.<br>回答总体连贯且持续，能够传达相关信息，但深入或具体阐述不足，缺乏具体细节。观点衔接有时不够清晰。</td>
    </tr>
    <tr>
        <td>2</td>
        ...
        <td>The response is connected to the task, though the number of ideas presented or the development of ideas is limited. Mostly basic ideas are expressed with limited elaboration (details and support). At times relevant substance may be vaguely expressed or repetitious. Connections of ideas may be unclear.<br>回答虽与任务相关，但观点数量或展开深度有限。大多表达较基础，细节较少，偶有模糊或重复，观点衔接不够清晰。</td>
    </tr>
    <tr>
        <td>1</td>
        ...
        <td>Range and control of grammar and vocabulary severely limit or prevent expression of ideas and connections among ideas. Some low-level responses may rely heavily on practiced or formulaic expressions.<br>语法和词汇的范围及掌控严重受限，难以表达思想及其联系。某些回答严重依赖预先准备或模板化语言。</td>
...
<table>
  ...
  <tr>
    ...
    <td>The response is sustained and conveys relevant information required by the task. However, it exhibits some incompleteness, inaccuracy, lack of specificity with respect to content, or choppiness in the progression of ideas.<br>回答基本连贯，传达了所需信息，但在内容完整性、准确性或具体性方面有所欠缺，思路展开有时略显跳跃。</td>
  </tr>
  <tr>
    <td>2</td>
...
**1 句引入 → 2–3 个具体要点（人/时/地/事/如何）→ 感受或影响 → 1 句总结**  
